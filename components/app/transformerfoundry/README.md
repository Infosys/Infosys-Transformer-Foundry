...
~~This project was generated with [Angular CLI](https://github.com/angular/angular-cli) version 8.1.2.~~ **`Upgraded to Angular CLI: 12.2.18`**
...
The RAG playground depends on [Document Extraction Library](https://www.github.com/Infosys/Document-Extraction-Libraries).
