...
class Model:
    def __init__(
        self, name: str, enabled: bool, capabilities: List[str],  provider: str, status: str, parameters: dict = None, tasktype: str = None, endpoint: str = None, metadata: dict = None
    ):
        self.name = name
    ...
    def __repr__(self):
        return f'Model({self.name}, {self.capabilities}, {self.enabled}, {self.provider}, {self.status}, {self.parameters}, {self.tasktype}, {self.endpoint}, {self.metadata})'
    ...
    def default(self, obj):
        if isinstance(obj, Model):
            properties = {
                ...
                "enabled": obj.enabled, "status": obj.status, "parameters": obj.parameters, "tasktype": obj.tasktype, "endpoint": obj.endpoint, "metadata": obj.metadata
            }
    ...
    def default(self, obj):
        if isinstance(obj, Provider):
            models = [{
                ...
                "status": model.status, "parameters": model.parameters, "tasktype": model.tasktype,
                "endpoint": model.endpoint, "metadata": model.metadata
