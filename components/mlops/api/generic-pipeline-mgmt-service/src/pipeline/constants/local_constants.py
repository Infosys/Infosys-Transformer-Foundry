...
CREATE_PIPELINE_JOB_ERROR = "Error Occured while creating pipeline"
VARIABLE_KEY_ERROR = "key is not valid variables"
GLOBALVARIABLE_KEY_ERROR = "key is not valid globalvariables"
VARIABLE_EMPTY_ERROR = "variables should not be empty"
EXECUTION_NOT_FOUND_ERROR = "execution id not found"
COMPUTE_TYPE = "Cannot assign multiple memories of same type in a single compute"
UPDATE_RESOURCECONFIG_ERROR = "Create a new pipeline to update values other than resourceconfig"
DATA_STORAGE_ERROR = "Only one entry is allowed in data storage"
...
class ErrorCode(Enum):
    ...
    VERSION_TYPE_ERROR = Error(2833, VERSION_TYPE_ERROR)
    CREATE_PIPELINE_JOB_ERROR = Error(2834, CREATE_PIPELINE_JOB_ERROR)
    VARIABLE_KEY_ERROR = Error(2835, VARIABLE_KEY_ERROR)
    GLOBALVARIABLE_KEY_ERROR = Error(2836, GLOBALVARIABLE_KEY_ERROR)
    VARIABLE_EMPTY_ERROR = Error(2037, VARIABLE_EMPTY_ERROR)
    EXECUTION_NOT_FOUND_ERROR = Error(2038, EXECUTION_NOT_FOUND_ERROR)
    COMPUTE_TYPE = Error(2039, COMPUTE_TYPE)
    UPDATE_RESOURCECONFIG_ERROR = Error(2040, UPDATE_RESOURCECONFIG_ERROR)
    DATA_STORAGE_ERROR = Error(2041, DATA_STORAGE_ERROR)