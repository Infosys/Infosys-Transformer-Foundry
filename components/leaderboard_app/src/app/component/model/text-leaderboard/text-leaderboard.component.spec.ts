...
import { TextLeaderboardComponent } from "./text-leaderboard.component";
...
describe('Text Leaderboard', () => {
    let component: TextLeaderboardComponent;
    let fixture: ComponentFixture<TextLeaderboardComponent>;

    beforeEach( async() => {
        await TestBed.configureTestingModule({
            declarations: [TextLeaderboardComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(TextLeaderboardComponent);
